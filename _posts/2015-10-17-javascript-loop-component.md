---
id: 481
title: JavaScript模块循环加载
date: '2015-10-17T18:57:10+08:00'
author: wenjie
layout: post
guid: 'https://javascript.shop/?p=481'
permalink: /2015/10/javascript-loop-component
categories:
    - Javascript
---
...
上面代码中，该对象的`id`属性是模块名，`exports`属性是模块输出的各个接口，`loaded`属性是一个布尔值，表示该模块的脚本是否执行完毕。其他还有很多属性，这里都省略了。（详细介绍情参见[《require() 源码解读》](http://www.ruanyifeng.com/blog/2015/05/require.html)。）
