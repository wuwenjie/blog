...
id: 527
title: webpack的基础入门
date: '2016-09-12T23:21:15+08:00'
author: wenjie
layout: post
guid: 'https://javascript.shop/?p=527'
permalink: /2016/09/webpack-beginning
categories:
    - 'HTML&amp;CSS'
    - Javascript
---
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">// 一个常见的`webpack`配置文件
...
<figure class="wp-block-image">![](//upload-images.jianshu.io/upload_images/1031000-d0693c06bb3a00e3.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1000/format/webp)</figure>Grunt和Gulp的工作流程

Webpack的工作方式是：把你的项目当做一个整体，通过一个给定的主文件（如：index.js），Webpack将从这个文件开始找到你的项目的所有依赖文件，使用loaders处理它们，最后打包为一个（或多个）浏览器可识别的JavaScript文件。

<figure class="wp-block-image">![](//upload-images.jianshu.io/upload_images/1031000-160bc667d3b6093a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1000/format/webp)</figure>Webpack工作方式
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">//全局安装
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">npm init
```
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">// 安装Webpack
npm install --save-dev webpack
```
...
<figure class="wp-block-image">![](//upload-images.jianshu.io/upload_images/1031000-976ba1a06fd0702f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/347/format/webp)</figure>项目结构
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">// Greeter.js
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">//main.js 
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title=""># {extry file}出填写入口文件的路径，本文中就是上述main.js的路径，
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title=""># webpack非全局安装的情况
node_modules/.bin/webpack app/main.js public/bundle.js
```

结果如下

<figure class="wp-block-image">![](//upload-images.jianshu.io/upload_images/1031000-b9e69a58e3518ba7.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/854/format/webp)</figure>使用命令行打包

可以看出`webpack`同时编译了`main.js` 和`Greeter,js`,现在打开`index.html`,可以看到如下结果

<figure class="wp-block-image">![](//upload-images.jianshu.io/upload_images/1031000-6cf1ecc41ef8c31d.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/802/format/webp)</figure>htmlResult1
...
<figure class="wp-block-image">![](//upload-images.jianshu.io/upload_images/1031000-c02a675d8d8c9e56.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/854/format/webp)</figure>配合配置文件进行打包
...
<figure class="wp-block-image">![](//upload-images.jianshu.io/upload_images/1031000-a3e10146ffac4163.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/842/format/webp)</figure>使用npm start 打包代码
...
<figure class="wp-block-image">![](//upload-images.jianshu.io/upload_images/1031000-47d5bea9ef177187.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/898/format/webp)</figure>开启本地服务器
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">var config = require('./config.json');
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">// npm一次性安装多个依赖模块，模块之间用空格隔开
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">npm install --save react react-dom
```
...
<figure class="wp-block-image">![](//upload-images.jianshu.io/upload_images/1031000-7d2a7769709a2e36.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/278/format/webp)</figure>localhost:8080
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">//.babelrc
{
  "presets": ["react", "env"]
}
```
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">//安装
npm install --save-dev style-loader css-loader
```

```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">//使用
module.exports = {
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">/* main.css */
html {
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">/* Greeter.css */
.root {
...
<figure class="wp-block-image">![](//upload-images.jianshu.io/upload_images/1031000-61f802a003991423.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/790/format/webp)</figure>应用了css module后的样式
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">npm install --save-dev postcss-loader autoprefixer
```

接下来，在webpack配置文件中添加`postcss-loader`，在根目录新建`postcss.config.js`,并添加如下代码之后，重新使用`npm start`打包时，你写的css会自动根据Can i use里的数据添加不同前缀了。

```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">//webpack.config.js
module.exports = {
    ...
    module: {
        rules: [
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">// postcss.config.js
module.exports = {
    plugins: [
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">const webpack = require('webpack');
...
<figure class="wp-block-image">![](//upload-images.jianshu.io/upload_images/1031000-9d190ecceaeb9e0e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/462/format/webp)</figure>版权所有，翻版必究
...
<figure class="wp-block-image">![](//upload-images.jianshu.io/upload_images/1031000-0e13dc8a49d9cda5.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/510/format/webp)</figure>build文件夹
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">npm install --save-dev babel-plugin-react-transform react-transform-hmr
```
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">// webpack.production.config.js
const webpack = require('webpack');
const HtmlWebpackPlugin = require('html-webpack-plugin');
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">//package.json
{
  "name": "test",
  "version": "1.0.0",
  "description": "",
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">npm install --save-dev extract-text-webpack-plugin
```
...
<figure class="wp-block-image">![](//upload-images.jianshu.io/upload_images/1031000-f9b89ce486539162.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1000/format/webp)</figure>压缩后的代码
...
<figure class="wp-block-image">![](//upload-images.jianshu.io/upload_images/1031000-2441bb1e9f8f5908.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/888/format/webp)</figure>带hash值的js名
...
```
<pre class="EnlighterJSRAW" data-enlighter-group="" data-enlighter-highlight="" data-enlighter-language="generic" data-enlighter-linenumbers="" data-enlighter-lineoffset="" data-enlighter-theme="" data-enlighter-title="">const CleanWebpackPlugin = require("clean-webpack-plugin");
  plugins: [
    ...// 这里是之前配置的其它各种插件
