---
id: 404
title: 'JavaScript 运行机制 单线程？'
date: '2014-10-25T13:39:29+08:00'
author: wenjie
layout: post
guid: 'https://javascript.shop/?p=404'
permalink: /2014/10/javascript-event-loop
categories:
    - Javascript
---
...
<figure class="wp-block-image">![任务队列](http://www.ruanyifeng.com/blogimg/asset/2014/bg2014100801.jpg)</figure>只要主线程空了，就会去读取”任务队列”，这就是JavaScript的运行机制。这个过程会不断重复。
...
<figure class="wp-block-image">![Event Loop](http://www.ruanyifeng.com/blogimg/asset/2014/bg2014100802.png)</figure>上图中，主线程运行的时候，产生堆（heap）和栈（stack），栈中的代码调用各种外部API，它们在”任务队列”中加入各种事件（click，load，done）。只要栈中的代码执行完毕，主线程就会去读取”任务队列”，依次执行那些事件所对应的回调函数。
...
<figure class="wp-block-image">![Node.js](http://www.ruanyifeng.com/blogimg/asset/2014/bg2014100803.png)</figure>根据上图，Node.js的运行机制如下。
